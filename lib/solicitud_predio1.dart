      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 74.0, end: 75.0),
            child:
                // Adobe XD layer: 'Lorem ipsum dolor s…' (text)
                const Text(
              'Para continuar con la segunda parte de  los datos del predio, presione:',
              style: TextStyle(
                fontFamily: 'Arial',
                fontSize: 14,
                color: Color(0xff2699fb),
...
const String _svg_lwwdg3 =
    '<svg viewBox="361.0 611.2 9.4 6.1" ><path transform="translate(359.0, 609.21)" d="M 6.699999809265137 8.100000381469727 L 2 3.400000095367432 L 3.400000095367432 2 L 6.699999809265137 5.300000190734863 L 10 2 L 11.39999961853027 3.400000095367432 L 6.699999809265137 8.100000381469727 Z" fill="#2699fb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
